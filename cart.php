   ...
   <div id="content"><!-- #content Begin -->
       <div class="container"><!-- container Begin -->
           ...
           <div id="cart" class="col-md-9"><!-- col-md-9 Begin -->
               ...
               <ul class="box"><!-- box Begin -->
                  
                  <form action="cart.php" method="post" enctype="multipart/form-data">
                  
                  	<h1>Shopping Cart</h1>
                  	<p class="text-muted">You Currently Have 3 item(s)</p>
                  	...
                  	<div class="box-footer"><!-- box-footer Begin-->
                  		...
                  		<div class="pull-right"><!--pull-right Begin-->
                  			...
                  			<a href="checkout.php" class="btn btn-primary"><!--btn btn-default Begin-->
                  			
                  				Proceed Checkout <i class="fa fa-chevron-rigth"></i>
           ...
           <div class="col-md-3"><!-- col-md-3 Begin-->
           		...
           		<div id="order-summary" class="box"><!-- box Begin-->
           			...
           			<p class="text-muted"><!-- text-muted Begin-->
           				...
           				Shipping and aditional costs are calculated based on value you have entered
